...
def make_movie(h5filename, fps=20, output=None):
    with h5py.File(h5filename, 'r') as f:
        ...
        # n0 = f['groundstate/1/psiR'][:]**2 + f['groundstate/1/psiI'][:]**2
    ...
    c1 = ax.imshow(density[0], extent=extent, vmin=0, vmax=density[0].max())
    ...
    text = ax.text(0, 1.23, f"t = {t[0]:.3f}",
